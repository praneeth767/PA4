...
def python_rand( num_iterations ):
    ...
    outFile = open("Python_bultin.txt", "w")
    ...
    outFile.close()
    print("Successfully stored %d random numbers in file named: 'Python_bultin.txt'.", num_iterations)
...
def generate_lcg( num_iterations ):
    ...
    outFile.close()
    print("Successfully stored " + str(num_iterations) + " random numbers in file named: 'LGC.txt'.")
